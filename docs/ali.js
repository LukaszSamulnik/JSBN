...
function renderBooks() {
  console.log('sessionstorage', Modernizr.sessionstorage); // myPage  creates variable storing some important nodes that are built with HTML (and not rendered by this function )and therefore can be determined immy after load event
  ...
  var books = {
    ...
    get: function get() {
      return this.areInStorage() ? load("localBooks") : this.fromRemote;
    } //========================================== FORM OPERATIONS ===================================================================
